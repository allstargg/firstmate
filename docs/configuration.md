...
The primary copies the presence flag into Secondmate homes and snapshots its effective decision as a non-empty `FM_TRACE_CONTEXT=on|off` override when it launches a Secondmate.
